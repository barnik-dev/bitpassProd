...
for (let i = 0; i < openModalDelete.length; i++) {
  ...
  openModalDelete[i].addEventListener("click", () => {
    ...
    // SETTING FORM ACTION TO A URL THROUGH WHICH WE CAN DELETE ACCOUNT PASSWORD (BASCIALLY SENDING THE ID OF THE ACCOUNT PASSWORD OBJECT THROUGH URL)
...
// IF USER PRESSES THE CANCEL BUTTON ON DELETE HTML PAGE BELOW LOGIC WILL EXECUTE
if (cancelDelete) {
